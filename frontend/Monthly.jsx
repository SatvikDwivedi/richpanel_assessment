    ...
    <div className="flex flex-col bg-white items-center w-[70vw] p-12 gap-6 rounded-md">
      ...
      <div className="w-full">
        <div className="flex justify-between items-center">
          <div className="flex bg-[#1F4D90] rounded-full gap-2 px-4 py-1 h-[5vh] items-center text-white text-xs pr-8">
        ...
        <div className="w-full flex flex-col gap-4 my-6 text-sm">
          <div className="flex justify-between">
            ...
            <div className="flex justify-evenly text-center w-[50%]">
              <p className="w-24">$100</p>
              <p className="w-24 text-[#1F4D90] font-semibold">$200</p>
              <p className="w-24">$500</p>
              <p className="w-24">$700</p>
            </div>
          </div>
